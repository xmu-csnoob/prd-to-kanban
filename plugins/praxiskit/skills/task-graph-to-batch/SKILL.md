...
Batch schema: `schemas/execution-batch.schema.md`. Template: `templates/execution-batch.md`.
...
- If no baseline command exists, set `baseline.status = unavailable` and keep dry-run.
